...
//	    }
	    ...
	    public ModelAndView professor(@PathVariable Long id) {
	        ModelAndView modelAndView = new ModelAndView("professores/professor");
	    ...
	    public ModelAndView cadastrar() {
	        ModelAndView modelAndView = new ModelAndView("professores/cadastro");
...
//		    }
		 ...
		 @GetMapping("/meusAlunos")
		    public ModelAndView jogos() {	    
			 ModelAndView modelAndView = new ModelAndView("professores/meusAlunos");
			 return modelAndView;
		    }
